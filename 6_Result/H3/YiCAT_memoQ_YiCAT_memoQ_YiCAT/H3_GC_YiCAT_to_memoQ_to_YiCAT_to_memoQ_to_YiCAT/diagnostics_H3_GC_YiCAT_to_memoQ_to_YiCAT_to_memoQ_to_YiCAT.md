...
- Level: **unstable route segment**
- Rationale: content-layer mean=66.5; structure-layer mean=69.19; metadata/identifier-layer mean=75.0; detected: language_code_case_normalised, tool_specific_props_added, header_values_changed, header_fields_added
...
- Level: **unstable route segment**
- Rationale: content-layer mean=66.5; structure-layer mean=95.16; metadata/identifier-layer mean=16.67; detected: tuid_overlap_low_matching_fell_back_to_text_or_position, tuid_removed_or_reassigned, language_code_case_normalised, pre_existing_props_removed_or_replaced, header_values_changed, header_fields_lost
...
- Level: **unstable route segment**
- Rationale: content-layer mean=68.52; structure-layer mean=108.0; metadata/identifier-layer mean=66.67; detected: tuid_overlap_low_matching_fell_back_to_text_or_position, tuid_removed_or_reassigned, inline_tags_expanded_or_reencoded; matching confidence=medium; inspect per-TU CSV if needed
