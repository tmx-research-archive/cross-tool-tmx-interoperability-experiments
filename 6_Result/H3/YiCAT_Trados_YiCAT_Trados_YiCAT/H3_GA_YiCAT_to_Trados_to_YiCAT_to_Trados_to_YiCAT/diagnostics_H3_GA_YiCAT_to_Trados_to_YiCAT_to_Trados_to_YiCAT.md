# Route diagnostics: H3 YiCAT → Trados → YiCAT → Trados → YiCAT
...
- Rationale: content-layer mean=100.0; metadata/identifier-layer mean=58.33; detected: tuid_overlap_low_matching_fell_back_to_text_or_position, tuid_removed_or_reassigned, tool_specific_props_added, header_values_changed, header_fields_added
...
- Level: **partially stable route segment**
- Rationale: content-layer mean=100.0; metadata/identifier-layer mean=29.17; detected: pre_existing_props_removed_or_replaced, header_values_changed, header_fields_lost
- Matching: hybrid, confidence=high, methods={'alignment_text_fingerprint': 99}, low-confidence=0
