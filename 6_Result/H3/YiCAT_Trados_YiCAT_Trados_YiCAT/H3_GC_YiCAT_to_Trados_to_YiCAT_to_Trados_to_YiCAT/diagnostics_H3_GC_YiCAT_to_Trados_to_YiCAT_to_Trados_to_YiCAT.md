...
- Rationale: content-layer mean=100.0; structure-layer mean=99.93; metadata/identifier-layer mean=58.33; detected: tuid_overlap_low_matching_fell_back_to_text_or_position, tuid_removed_or_reassigned, tool_specific_props_added, header_values_changed, header_fields_added
- Matching: hybrid, confidence=high, methods={'alignment_text_fingerprint': 86}, low-confidence=0
